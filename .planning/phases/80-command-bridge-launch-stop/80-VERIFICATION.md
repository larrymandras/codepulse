...
overrides_applied: 0
live_round_trip: "PASSED at bridge level 2026-06-16 — launch (job 01KV8Q60AX3W4S4VQQRQ8MZPE3 reflected) + stop (job 01KV8Q8BJVR91TPVQ6F3HJYT5Q -> stopped). Caught + fixed a real daemon bug (loopback POST /jobs missing bearer, forge 737845e). Clerk-gated UI click-through deferred (Clerk not configured locally — see 80-HUMAN-UAT.md). FI-06 bridge fully proven both directions; FI-08 UI auth verified by tests + code."
human_verification:
