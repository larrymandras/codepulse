...
RESOLVED 2026-07-21 (post-verification): the WR-04 design gap was signed off by Larry and fixed — D-05 narrowed to target-scoped cold-only (delete must target the Cold Storage copy; co-existing active copies no longer refuse). Commits: codepulse d4ab72f, forge 42d2f79; both full suites green after the change (codepulse 2327, forge 1008). The archive-collision “delete it first” remediation now works end-to-end for shadowed skills.
