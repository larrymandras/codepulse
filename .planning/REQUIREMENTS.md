...
- [x] **KG-11**: Operator diffs the KG between two as-of points and/or animates its evolution over time, building on the existing single-point as-of "temporal" lens
