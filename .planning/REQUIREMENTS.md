...
- [ ] **TH-06**: **A11y pass** — every theme verified for WCAG-AA contrast on the highest-traffic surfaces (Dashboard, Live Run, Analytics, Forge, Graphs) via `@axe-core/playwright` in the existing Playwright path.
