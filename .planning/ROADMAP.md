...
| 121. Analytics Query Resilience | v15.0 | 5/7 | Executing | - | 7 plans in 4 waves. Wave 4 (`121-07`) is attended (`autonomous: false`) — deploy to the self-hosted backend, resumed backfill chain, live read-cap measurement. |
