...
**UI hint**: yes
**Plans:** 18 plans (5 waves + 5 gap-closure waves)
...
- [ ] 103-18-PLAN.md — Closes review WR-01 by hoisting global-swap ownership into a `DashboardLayout`-level provider, above the router outlet, so the revert closure survives navigation; must preserve CR-03 (103-12), 103-14 (revert-to-prior), and 103-16 (selection-nonce reset) — not yet executed.
