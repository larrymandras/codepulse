...
- [x] 79-02-PLAN.md — Composed components: ForgeMetadataPanel + ForgeJobList + ForgeJobDetail (port + strip action controls per D-01/D-02) (FI-05) [wave 2]
- [x] 79-03-PLAN.md — ForgePage master-detail + /forge route (App.tsx) + CONSOLE nav entry with Flame icon (DashboardLayout.tsx) (FI-04) [wave 3]
