  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5 min-w-0">
        ...
        {tool.disabled && (
          <span className="text-[10px] font-mono uppercase tracking-wider text-amber-500 flex-shrink-0">
            pruned
          </span>
        )}
      </div>
      ...
      <div className="flex items-center gap-4 flex-shrink-0">
        ...
        <button
          ...
          className={`flex items-center gap-1 rounded-full border px-2.5 py-1 text-[11px] font-mono uppercase tracking-wide transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${
            tool.disabled
    ...
    >
      ...
      >
        <div className="flex items-center gap-3 min-w-0">
          ...
          <StatusBadge status={badge.semantic} label={badge.label} />
          {group.origin && (
            <span className="text-[10px] px-1.5 py-0.5 rounded bg-(--info)/10 text-(--info) flex-shrink-0">
              {group.origin}
            </span>
          )}
        </div>
      ...
      {open && (
        <div className="border-t border-border/50 px-3 py-3 space-y-1.5">
          {group.url && (
            <p className="text-[11px] font-mono text-muted-foreground px-1 pb-1 truncate">
