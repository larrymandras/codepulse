...
export function ClusterDetailCard({
  ...
  return (
    <div
      className="absolute top-4 right-4 z-20 flex max-h-[calc(100%-2rem)] w-[340px] max-w-[calc(100%-2rem)] flex-col overflow-hidden rounded-2xl border border-white/10 bg-popover/85 backdrop-blur-xl"
    ...
    >
      ...
      <div className="flex items-start gap-3 p-4 pb-3">
        ...
        <div className="min-w-0 flex-1">
          <h3 className="truncate text-[15px] font-semibold leading-tight text-foreground">{cluster.categoryLabel}</h3>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-2 pb-2">
        {cluster.skills.map((s) => (
          ...
          >
            ...
            {s.useCount > 0 && <span className="shrink-0 text-[11px] tabular-nums text-muted-foreground">{s.useCount}×</span>}
