...
export default function GitActivityWidget() {
  ...
  return (
    <div className="glow-card bg-card/60 backdrop-blur-md border border-border/50 rounded-xl p-6 relative overflow-hidden flex flex-col max-h-[450px] hover:border-primary/50 transition-colors shadow-[var(--glow-xs)] hover:shadow-[var(--glow-sm)]">
      ...
      {/* Summary stats */}
      {summary && (
        <div className="grid grid-cols-4 gap-3 mb-6 text-xs uppercase font-mono tracking-widest">
          ...
          <div className="bg-background/50 border border-border/30 rounded-lg p-2 text-center shadow-[0_0_10px_rgba(0,0,0,0.2)] hover:border-primary/40 transition-colors">
            ...
            <p className="text-base font-bold tracking-tight text-green-400">
              +{summary.linesAdded}
            </p>
          </div>
          <div className="bg-background/50 border border-border/30 rounded-lg p-2 text-center shadow-[0_0_10px_rgba(0,0,0,0.2)] hover:border-primary/40 transition-colors">
            <p className="text-primary/70 mb-1">- Lines</p>
            <p className="text-base font-bold tracking-tight text-red-400">
