        ...
        <table className="w-full text-base">
          ...
          <tbody>
            {links.map((link: any, i: number) => {
              ...
              return (
                <tr key={i} className="border-b border-border/50 hover:bg-[var(--surface-3)]/20">
                  <td className="py-2 pr-3 text-foreground">{sourceName}</td>
                  <td className="py-2 px-3 text-foreground">{targetName}</td>
                  <td className="py-2 pl-3 text-right text-muted-foreground">{link.value}</td>
                </tr>
              );
            })}
          </tbody>
